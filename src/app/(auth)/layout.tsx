...
import { AuthSplashWrapper } from "@/features/auth/components/auth-splash-wrapper";
...
export default function AuthLayout({
  ...
  return (
    <AuthSplashWrapper>
      <div className="relative flex min-h-[100dvh] flex-col" style={{ backgroundColor: "#F5F5F7" }}>
